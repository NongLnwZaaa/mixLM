...
st.title("📈 การถดถอยโลจิสติก (Logistic Regression)")
...
max_iter = st.sidebar.slider("จำนวนรอบการทำงานสูงสุด (Max Iterations)", 100, 1000, 200)
...
# ส่วนทำนายคนไข้ใหม่
st.subheader("🩺 ทำนายผลความเสี่ยงคนไข้ใหม่ (Logistic Regression)")
